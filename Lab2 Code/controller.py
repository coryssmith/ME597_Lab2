...
class controller:
    ...
    def __init__(self, klp=0.8, klv=0.2, kli=0.2, kap=0.2, kav=0.2, kai=0.2):
    ...
    def vel_request(self, pose, goal, status):
        ...
        linear_vel = min(max(linear_vel, -0.31), 0.31)  # Limit between -0.31 and 0.31 m/s
        angular_vel = min(max(angular_vel, -1.9), 1.9)  # Limit between -1.9 and 1.9 rad/s
