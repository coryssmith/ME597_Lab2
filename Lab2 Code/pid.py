...
class PID_ctrl:
    ...
    def __update(self, stamped_error):
        ...
        self.history.append(stamped_error)      #Add last error to the history  
        ...
        for i in range(1, len(self.history)):
            ...
            # Calculate the difference in error over the average time step
        ...
        for hist in self.history:
            ...
            sum_ += hist[0]     # Integrate the error over the history window
        
        error_int=sum_*dt_avg    # Multiply the sum of errors by the average time step
        ...
        # TODO Part 5: Implement the control law corresponding to each type of controller
            ...
            return self.kp * latest_error + self.kv * error_dot # return ... # complete
        
        elif self.type == PI:
            return self.kp * latest_error + self.ki * error_int # return ... # complete
        
        elif self.type == PID:
            return self.kp * latest_error + self.kv * error_dot + self.ki * error_int # return ... # complete
